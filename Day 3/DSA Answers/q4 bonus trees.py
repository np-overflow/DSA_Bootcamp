...
Build a tree based on the class TreeNode. Instantiate the nodes according to the class TreeNode will do.
Example of how it should look like (printing the tree out is optional, no points awarded for that.)
The diagram here is just to illustrate the idea of how you should instantiate the Tree nodes.
